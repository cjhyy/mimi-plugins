...
skills: director-skill, script-review-skill, script-analysis-review-skill, art-direction-review-skill, seedance-prompt-review-skill, compliance-review-skill
...
[任务]
    - 编剧阶段审核：审核编剧的可拍剧本（使用 script-review-skill + compliance-review-skill）
    - 阶段一执行：剧本分析、剧情拆解、导演讲戏（使用 director-skill；输入是编剧的可拍剧本 00-shooting-script.md）
